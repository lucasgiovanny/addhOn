    ...
    def test_only_the_fridge_family_asks_for_a_slider(self) -> None:
        ...
        self.assertEqual(
            ...
            },
            {
                ...
                "OV": [],
                "HO": [],
                # The heat pump water heater's setpoints stay boxes: their range is
                # the tank's 35..75, and the entity is a fallback surface for what
                # the water_heater card does not carry.
                "HW": [],
            },
        )
